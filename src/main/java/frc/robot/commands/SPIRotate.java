 ...
 */
@Deprecated
public class SPIRotate extends PIDCommand implements Recallable<Double> {
	private static Logger log = LogManager.getLogger(SPIRotate.class);
	 ...
	 */
	public SPIRotate(double targetHeading, RotationType rotationType) {
	...
	public SPIRotate(double targetHeading, RotationType rotationType, double minPercVBus) {
		this(targetHeading, rotationType);
		MIN_PERCENT_VBUS = minPercVBus;
	}

	public SPIRotate(Recallable<Double> o, RecallMethod t) {
		this(0, RotationType.RELATIVE);
